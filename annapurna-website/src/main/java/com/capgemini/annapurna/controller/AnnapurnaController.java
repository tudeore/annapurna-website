...
//		System.out.println("Inside update");
	...
	public String addCart(/* @RequestParam String restaurantName, */ @RequestParam String foodName,
		...
		if (count == 1) {
			...
			restTemplate.put("http://annapurna-cart/carts/" /* "http://10.246.92.254:8181/carts/" */ + cart.getCartId(),
					cart, Cart.class);
			// System.out.println(cart);
		}
		...
		ResponseEntity<Cart> entity = restTemplate
				.getForEntity(/* "http://10.246.92.254:8181/carts/" */ "http://annapurna-cart/carts/"+ cart.getCartId() + "", Cart.class);
	...
	public String cancelOrder(@RequestParam("orderId") Integer orderId, Model model) {
		...
		restTemplate.delete(/* "http://10.246.92.254:9090/orders/" */ "http://annapurna-order/orders/"+ orderId + "", Order.class);
